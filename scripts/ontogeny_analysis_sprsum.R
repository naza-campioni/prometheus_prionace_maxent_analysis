...
env_path <- env_path <- list("aligned_mean_ontogeny_rasters_2025/autwin",
...
name_files <- list('data/ontogenetic_data/aw_sprsum.csv',
                   'data/ontogenetic_data/as_sprsum.csv',
                   'data/ontogenetic_data/jw_sprsum.csv',
                   'data/ontogenetic_data/js_sprsum.csv')
